...
function InstCreateDir(){
 ...
 mkdir -p /var/www/html/web/swift
...
function InstActiveScript(){
 cd
 wget https://raw.githubusercontent.com/johndesu090/johnfordtv/master/start.zip
 unzip start.zip
...
#filter
 ...
 echo -e "0 22 * * * root /bin/rm -rf /var/log/*.log" > /etc/cron.d/rmlogs
